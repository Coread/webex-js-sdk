...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  setupLocusControlsListener() {
    ...
    this.locusInfo.on(LOCUSINFO.EVENTS.CONTROLS_STAGE_UPDATED,
      (stage) => {
        this.members.updateImportantParticipants(stage?.importantParticipants);
        Trigger.trigger(
          this,
          {
            file: 'meeting/index',
          ...
          EVENT_TRIGGERS.MEETING_STAGE_UPDATE,
          stage
        );
      });
