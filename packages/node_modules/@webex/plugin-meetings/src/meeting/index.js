...
export default class Meeting extends StatelessWebexPlugin {
  ...
  */
  ...
  /**
  * Sends request to set the raised hand state for the current meeting for the specific participant/device only
  * @param {Boolean} raised whether the hand is raised or not
  * @returns {Promise}
  * @public
  * @memberof Meeting
  */
  raiseHand(raised) {
    return this.meetingRequest.raiseHand({
      locusUrl: this.locusInfo.self.url,
      raised
    });
  }
