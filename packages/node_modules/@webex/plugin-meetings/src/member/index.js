...
export default class Member {
  ...
  processParticipantOptions(participant, options) {
    if (participant && options) {
      ...
      this.processIsImportant(participant, options.importantParticipants);
    }
  }
  ...
  /**
   * Determine if this member is important
   * @param {Object} participant
   * @param {Array<Object>} importantParticipants
   * @returns {undefined}
   */
  processIsImportant(participant, importantParticipants) {
    let important = false;

    importantParticipants.forEach((importantParticipant) => {
      if (MemberUtil.isSame(participant, importantParticipant.participantId)) {
        important = true;
      }
    });
