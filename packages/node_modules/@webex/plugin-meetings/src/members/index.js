...
export default class Members extends StatelessWebexPlugin {
  ...
  constructor(attrs, options) {
    ...
    */
    ...
    /**
     * The current important participants
     * that are on the stage, if the stage exists
     */
    this.importantParticipants = [];
  }
  ...
  handleLocusInfoUpdatedParticipants(payload) {
    ...
    this.importantParticipants = payload.importantParticipants || [];
  ...
  /**
   * Updates the importants state for members base on the current important participant array
   * @param {Array<Object>} importantParticipants
   * @returns {undefined}
   */
  updateImportantParticipants(importantParticipants) {
    this.importantParticipants = importantParticipants;
    forEach(this.membersCollection.getAll(), (member) => {
      member.processIsImportant(member.participant, importantParticipants);
    });
  }
        ...
        if (existing) {
          ...
          membersUpdate.updated.push(
            new Member(participant, {
              ...
              importantParticipants: this.importantParticipants,
              selfId: this.selfId,
              hostId: this.hostId,
